  ...
  return (
    <div>
      ...
      <div className="container-fluid">
          ...
          <div className={`col-lg-6 ${styles.contentLeft}`}>
            <div className="row">
              <div className={`col-lg-12 ${styles.titleApps}`}>
                <div className="row">
                  <div className="col-lg-12 col-4">
                    <h4
                      onClick={toLanding}
                      className={`ms-lg-5 ms-3 mt-4 mt-lg-5 ${styles.titleLanding}`}
                    >
                      Zwallet
                    </h4>
                  </div>
              ...
              <div className="col-lg-12 ms-lg-5 mb-lg-0 mb-5">
                <div className="row">
                  <div className={`col-lg-9  ${styles.jumbotronPack}`}>
          ...
          <div className={`col-lg-6 ${styles.jumbotronRight}`}>
            <div className="row">
              <div className={status === null ? `col-lg-12 mt-lg-4` : `d-none`}>
                <div
                  className={`d-grid gap-2 d-flex justify-content-end me-lg-5 mt-lg-3 ${styles.btnGroup}`}
                >
                  <button
        ...
        <div className={`d-lg-flex d-none row mt-lg-5 ${styles.partner}`}>
          <div className="col-lg-6">
            <div className={`row  ${styles.packTitle}`}>
              ...
              <div className={`col-lg-12 text-left mt-lg-3 ${styles.notebox}`}>
              <div
                className={styles.noteAbout}
              >
                <small className={``}>
